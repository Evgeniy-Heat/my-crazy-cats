...
const generateCard = (cat) => {
    ...
    <img src=${cat.image !== '' ? cat.image : "images/default.png"} alt="default" />
    </div>
    ...
    <button class="cat_card_view" value=${cat.id}>Cмотреть</button>
    ...
    const generateCardView = (cat) => {
        ...
        <div class="cardView">
        <div class="cardView_image" style ="background-image: url('${cat.image || 'images/default.png'}')">
        </div>
        <div class="cardView_content">
            <div class="card_name">${cat.name}</div>
            <div class="card_age"><span class="age">Возраст:<span>${cat.age}</div>
            <div class="card_rate">Рейтинг: ${cat.rate}</div>
